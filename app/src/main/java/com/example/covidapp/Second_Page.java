    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slidebutton1.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View view) {
                                                Intent intent =new Intent(Second_Page.this, First_Page.class);
        ...
        slidebutton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Second_Page.this,Second_Page.class);
                startActivity(intent);
            }
        });
        ...
        slidebutton4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Second_Page.this,Forth_Page.class);
                startActivity(intent);
            }
        });
    }
